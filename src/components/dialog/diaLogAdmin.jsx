...
export function DialogWithForm({ open, setOpen, songId }) {
  return (
    <>
      <Dialog size="md" open={open} className="bg-transparent shadow-none">
        <Card className="mx-auto w-full p-5">
          ...
          <div className="items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
            ...
            <button className="w-full sm:w-auto text-black justify-center inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
              Schedule
            </button>
            <button
